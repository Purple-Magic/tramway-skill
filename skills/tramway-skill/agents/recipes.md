...
- For adding, updating, generating, using, placing, wiring, or standardizing favicons, Apple touch icons, Android/PWA icons, or a web app manifest, open [agents/recipes/favicon.md](/home/pavel/projects/tramway-skill/skills/tramway-skill/agents/recipes/favicon.md). Also open it when the user mentions a file such as `favicon.png`, `favicon.ico`, `icon.png`, `logo.png`, or an uploaded/provided image that should become the site's favicon or browser tab icon.
