...
5. Apply/adapt those `Makefile`, deployment, and Terraform updates when they are applicable to the current project.
...
18. Summarize applied/skipped updates with reasons for every skipped item, including `Makefile`, deployment, and Terraform decisions.
